...
| create\_url\_map | Set to `false` if url\_map variable is provided. | `bool` | `false` | no |
...
| https\_redirect | Set to `true` to enable https redirect on the lb. | `bool` | `true` | no |
...
| certificate\_map | The certificate map used by this module. |
